...
public class RedundantAllocationConfirmationException extends DomainInvariantViolationException implements RedundantDomainActionException {
    public RedundantAllocationConfirmationException(String message) {
        super(message);
    }
}
